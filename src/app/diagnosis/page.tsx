        ...
        rightSlot={
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              title="トリアージ設定（管理者）"
              className="inline-flex size-10 items-center justify-center rounded-full bg-peco-primary-subtle text-xl hover:bg-peco-primary-light active:scale-95"
            >
              ⚙️
            </Link>
          </div>
